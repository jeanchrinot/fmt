...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	$users = [
    				...
    				['name'=>'Jean','surname'=>'Chrinot','birthday'=>$date,'gender'=>1,'province'=>'Kocaeli','phone'=>'0428562','email'=>'jean@gmail.com','department'=>'Electronics Engineering','type'=>2,'image'=>'chrinot.jpg'],

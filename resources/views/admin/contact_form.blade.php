    ...
    <form class=" needs-validation p-2" novalidate id="new-member" action="{{ route('contact.update',['id'=>$contact->id]) }}" method="post">
      ...
      <div class="form-row">
        <div class="col-md-4 mb-2">
          ...
          <input type="text" class="form-control" id="phone" placeholder="Téléphone" name="phone" value="{{ old('phone') ?? ($contact->phone ?? '') }}">
      ...
      <div class="form-row">
        <div class="col-md-4 mb-2">
          ...
          <textarea class="form-control" rows="3" name="address" id="address">{{ old('address') ?? ($contact->address ?? '') }}</textarea>
          <div class="invalid-feedback">

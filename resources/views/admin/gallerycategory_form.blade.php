...
@section('title','Ajouter une catégorie de galerie')
...
@endphp
  ...
  <div class="box-modif-student_word mt-3 mb-4 p-3 button-container bg-white border shadow-sm">
    <form class=" needs-validation p-2" novalidate id="new-member" action="{{ ($update==1) ? url('admin/gallerycategory/update/'.$category->id) :  url('admin/gallerycategory/store') }}" method="post">
      {{ csrf_field() }}

    ...
    <!--modif membre bureau-->
        <div class="box-modif-student_word mt-3 mb-4 p-3 button-container bg-white border shadow-sm">
            <form class=" needs-validation p-2" novalidate id="new-member"
                  action="{{ ($update==1) ? url('admin/member/update/'.$edit_user->id) :  url('admin/member/store') }}"
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="text" class="form-control" id="nom" placeholder="Nom" name="surname"
                               value="{{ old('surname') ?? ($edit_user->surname ?? '') }}" required>
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="text" class="form-control" id="prenom" placeholder="Prénoms" name="name"
                               value="{{ old('name') ?? ($edit_user->name ?? '') }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <div class="input-group">
                            <input type="date" class="form-control" id="birthday" aria-describedby="inputGroupPrepend"
                                   name="birthday" value="{{ old('birthday') ?? ($edit_user->birthday ?? '')  }}"
                                   required>
                            <div class="invalid-feedback">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-2">
                        ...
                        <select class="form-control" id="ville" name="province" required>
                            ...
                            @foreach(province('all') as $key=>$prov)
                                <option
                                    value="{{ $key+1 }}" {{ ($key+1==$province) ? 'selected="selected"' : '' }}>{{ $prov }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="telephone" class="form-control" id="telephone" placeholder="Téléphone" name="phone"
                               value="{{ old('phone') ?? ($edit_user->phone ?? '') }}" required>
                        <div class="invalid-feedback">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="department" placeholder="Departement ou filiere"
                                   name="department" value="{{ old('department') ?? ($edit_user->department ?? '') }}"
                                   required>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <label for="membre">Type du membre: <span class="text-danger">*</span></label>
                        <select class="form-control" id="memberType" name="type" currentType="{{ $current_type ?? '' }}"
                                required>
                        ...
                        <div class="col-md-4 mb-2 password" style="{{ ($type=='0') ? 'display: none' : '' }}">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="password" name="password"
                                       placeholder="Tapez un mot de passe sécurisé." {{ ($type=='1' || $type=='2') ? 'required' : '' }}>
                            </div>
                            <div class="invalid-feedback">
                ...
                <div class="form-row">
                    <div class="col-sm-6">
                        ...
                        <div class="custom-control custom-radio mb-2" style="float: left;">
                            <input type="radio" class="custom-control-input" id="femme" name="gender" value="2"
                                   {{ ($gender==2) ? 'checked': '' }} required>

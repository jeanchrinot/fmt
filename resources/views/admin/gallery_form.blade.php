        ...
        <div class="form-group">
          ...
          <div class="checkbox-group">
            ...
            @foreach($categories as $category)
             <input type="checkbox" id="{{ $category->id }}" name="categories[]" value="{{ $category->id }}" @php if(isset($gallery) && in_array($category->id,$gallerycats)) echo 'checked="checked"'; @endphp>

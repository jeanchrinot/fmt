  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 wow slideInLeft">
        ...
        @if($socials)
        <ul class="socials">
          <li class="socials__item"><a href="{{ $socials->facebook }}" target="_blank"><i
                class="mr-1 fa fa-facebook"></i> Facebook</a></li>
          <li class="socials__item"><a href="{{ $socials->twitter }}" target="_blank"><i class="mr-1 fa fa-twitter"></i>
              Twitter</a></li>
          <li class="socials__item"><a href="{{ $socials->youtube }}" target="_blank"><i class="mr-1 fa fa-youtube"></i>
              Youtube</a></li>
          <li class="socials__item"><a href="{{ $socials->instagram }}" target="_blank"><i
                class="mr-1 fa fa-instagram"></i> Instagram</a></li>
        </ul>
        @endif
      ...
      <div class="col-lg-4 wow bounce">
        ...
        <div class="row widget-gallery footer-gallery">
          ...
          <div class="widget-gallery__item">
            <a title="{{ $gallery->title }}" href="{{ getImage($gallery->image) }}"><img
                src="{{ getImage($gallery->image) }}" alt="{{ $gallery->title }}" /></a>
          </div>
          @endforeach
          @endif
      ...
      <div class="col-lg-4 pb-5 footer-link wow slideInRight">
        ...
        <p>
          <a class="quick-link" href="{{ route('page.actuality') }}"><i class="fa fa-angle-right"></i>
            Actualités</a></p>
        <p><a class="quick-link" href="{{ route('page.activity') }}"> <i class="fa fa-angle-right"></i> Activités</a>
        </p>
